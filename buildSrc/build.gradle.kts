...
object PluginsVersions {
    ...
    const val GOOGLE_PLAY_SERVICES = "4.2.0"
    const val FIREBASE_CRASHLYTICS = "2.0.0-beta04"
    const val FIREBASE_PERFORMANCE_MONITOR = "1.3.1"
...
dependencies {
    ...
    implementation("com.google.firebase:perf-plugin:${PluginsVersions.FIREBASE_PERFORMANCE_MONITOR}")
