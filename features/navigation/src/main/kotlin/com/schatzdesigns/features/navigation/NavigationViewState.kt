...
import com.schatzdesigns.commons.ui.base.BaseViewState

/**
 * Different states for [NavigationFragment].
 *
 * @see BaseViewState
 */
sealed class NavigationViewState : BaseViewState {

    /**
     * Full screen mode.
     */
    object FullScreen : NavigationViewState()

    /**
     * Navigation screen mode with bottom bar.
     */
    object NavigationScreen : NavigationViewState()
